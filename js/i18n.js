...
(function (global) {
    ...
    const STRINGS = {
        zh: {
            ...
            'toast.syncFailDetail1': '云同步失败：',
            'toast.syncFailDetail2': '（已仅保存在本地）',
            'toast.networkError': '网络错误，请求没有到达服务器',
        ...
        en: {
            ...
            'toast.syncFailDetail1': 'Cloud sync failed: ',
            'toast.syncFailDetail2': ' (saved locally only)',
            'toast.networkError': 'Network error — the request never reached the server',
